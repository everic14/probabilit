...
try:
    ...
    print(f"La probabilité que A soit vrai si B est vrai: {result:.3e}")
    print(f"La probabilité que A soit faux si B est vrai: {round(1 - result, 3):.3e}")
    print(f"La probabilité que B soit vrai si A est vrai:{prob_b_a:.3e}")
    print(f"La probabilité que B soit vrai si A est faux:{prob_b_nona:.3e}")
